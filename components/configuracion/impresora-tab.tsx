...
const DOWNLOAD_PATH = "print-service/jebbs-print-service.exe";
      ...
      <Card className="bg-card">
        ...
        <CardContent className="space-y-3">
          ...
          <Button onClick={handleDownload} className="gap-2">
            ...
            Descargar jebbs-print-service.exe
          </Button>
          <p className="text-caption text-muted-foreground">
            Guardalo en <code className="font-mono">C:\jebbs-print-service\</code> — es
          ...
          <ol className="space-y-4">
            <li className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-caption text-muted-foreground">
                  En <code className="font-mono">C:\jebbs-print-service\</code>, en la
            ...
            <li className="flex gap-3">
              <StepNumber n={2} />
              <div>
                <p className="font-medium">Ejecutá jebbs-print-service.exe</p>
                <p className="text-caption text-muted-foreground">
